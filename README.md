...
constants declared anywhere but the files you designate as their home, so the
decisions a program has made can be read as a set rather than hunted for; and
